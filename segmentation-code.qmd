...
***SIDEKICK: How to mention that this is a new feature? It wasn't included in Due Diligence.***
...
***SIDEKICK: TO DO - Include Justifications. Omitting variables with obviously useless but strong association to tenure, such as age. These should also have predictive value if we want to apply this to customers who are currently with the company and haven't been for long, and we want to know if they will have a longer tenture. for example, we can't know currently how long an employment history a customer will eventually have once they have a tenure of \> 59 months.***
...
***SIDEKICK To Do - Note this was determined after much trial an error, and justified by finding a good separation of high retention by cluster, as well as a good separation of features, as determined by the variance (spread) of the cluster means for each feature.
...
It would be nice to how similar the segments discovered by the two methods are.
...
***SIDEKICK: TO DO - Describe justification for choosing k Means segmentation
#### Visualize Segments
